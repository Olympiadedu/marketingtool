...
function getBlogDraftSystem(type) {
  ...
  var sectionGuide;
  if (targetLen <= 1000) {
    sectionGuide = '섹션 2~3개, 각 summary는 2~3문장으로 짧고 핵심만 담을 것';
  } else if (targetLen <= 2000) {
    sectionGuide = '섹션 3~4개, 각 summary는 3~5문장이며 구체적 사례를 1개 이상 포함할 것';
  } else {
    sectionGuide = '섹션 4~6개, 각 summary는 4~6문장이며 구체적 사례·수치·전환 흐름까지 포함해 최종 본문 확장 시 충분한 분량이 나오도록 상세히 작성할 것';
  }
  var lengthGuide = '목표 분량은 ' + targetLen + '자(공백 제외)이다. ' + sectionGuide;
